...
export default function FlashcardsPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/50">
      ...
      {/* Minimal Hero */}
      <section className="border-b border-border bg-card pb-12 pt-16">
                ...
                >
                  <div className="relative flex h-full flex-col rounded-xl bg-card p-6 shadow-sm ring-1 ring-border transition-all hover:-translate-y-1 hover:shadow-md hover:ring-ring/50">
                    ...
                    <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-muted transition-colors group-hover:bg-muted/80">
                      <IconComponent className="h-5 w-5 text-kkpsi-navy dark:text-kkpsi-navy-light" strokeWidth={1.5} />
                    </div>
        ...
        <div className="container mx-auto max-w-4xl px-4">
          <div className="grid gap-12 md:grid-cols-3">
            <div className="text-center">
              <div className="mx-auto mb-3 flex h-10 w-10 items-center justify-center rounded-full bg-kkpsi-navy/5 dark:bg-kkpsi-navy/20">
                <Zap className="h-5 w-5 text-kkpsi-navy dark:text-kkpsi-navy-light" strokeWidth={1.5} />
              </div>
            ...
            <div className="text-center">
              <div className="mx-auto mb-3 flex h-10 w-10 items-center justify-center rounded-full bg-kkpsi-navy/5 dark:bg-kkpsi-navy/20">
                <TrendingUp className="h-5 w-5 text-kkpsi-navy dark:text-kkpsi-navy-light" strokeWidth={1.5} />
              </div>
              <h3 className="mb-1 text-sm font-semibold text-foreground">
                Progress Tracking
              </h3>
            ...
            <div className="text-center">
              <div className="mx-auto mb-3 flex h-10 w-10 items-center justify-center rounded-full bg-kkpsi-navy/5 dark:bg-kkpsi-navy/20">
                <Layers className="h-5 w-5 text-kkpsi-navy dark:text-kkpsi-navy-light" strokeWidth={1.5} />
              </div>
              <h3 className="mb-1 text-sm font-semibold text-foreground">
                Question Variants
              </h3>
